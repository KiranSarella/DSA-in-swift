/** 
    ...
    https://github.com/raywenderlich/swift-algorithm-club/blob/master/Depth-First%20Search/depthFirstTraversal.playground/Pages/Simple%20Example.xcplaygroundpage/Contents.swift
...
func depthFirstTraversal(_ graph: Graph, startFrom source: Node) -> [String] {
    ...
    for edge in source.neighbors {
        ...
        if !edge.neighbor.visited {
            path += depthFirstTraversal(graph, startFrom: edge.neighbor)
        }
    }
...
let path = depthFirstTraversal(graph, startFrom: a)
print(path)
